...
public:
    PsuView(MCUFRIEND_kbv &tft, uint16_t x, uint16_t y)
        : _tft(tft), _x(x), _y(y), field_0(tft, _x + 0, _y + 5, 2, BLACK, WHITE),
          field_1(tft, _x + 80, _y + 5, 2, BLACK, WHITE), field_2(tft, _x + 0, _y + 35, 2, BLACK, WHITE),
          field_3(tft, _x + 80, _y + 35, 2, BLACK, WHITE)
    {
    }
    void invalidate()
    {
        _needs_initial_draw = true;
    }
...
public:
    PsuDetailView(MCUFRIEND_kbv &tft, uint16_t x, uint16_t y)
        : _tft(tft), _x(x + 5), _y(y + 5), field_0(tft, _x + 80, _y + 0, 2, BLACK, WHITE),
          field_1(tft, _x + 80, _y + 30, 2, BLACK, WHITE), field_2(tft, _x + 80, _y + 60, 2, BLACK, WHITE),
          field_3(tft, _x + 80, _y + 90, 2, BLACK, WHITE), field_4(tft, _x + 80, _y + 120, 2, BLACK, WHITE),
          field_5(tft, _x + 250, _y + 0, 2, BLACK, WHITE), field_6(tft, _x + 250, _y + 30, 2, BLACK, WHITE),
          field_7(tft, _x + 250, _y + 60, 2, BLACK, WHITE), field_8(tft, _x + 250, _y + 90, 2, BLACK, WHITE),
          field_9(tft, _x + 250, _y + 120, 2, BLACK, WHITE), field_10(tft, _x + 250, _y + 150, 2, BLACK, WHITE)
    {
    }
    void invalidate()
    {
    ...
    void update_draw(std::string _0, std::string _1, std::string _2, std::string _3, std::string _4, std::string _5,
